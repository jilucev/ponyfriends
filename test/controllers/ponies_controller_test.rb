...
class PoniesControllerTest < ActionController::TestCase
  ...
  test "should create pony" do
    assert_difference('Pony.count') do
      post :create, pony: { breed: @pony.breed, color: @pony.color, magical_power: @pony.magical_power, name: @pony.name }
    end
  ...
  test "should update pony" do
    patch :update, id: @pony, pony: { breed: @pony.breed, color: @pony.color, magical_power: @pony.magical_power, name: @pony.name }
    assert_redirected_to pony_path(assigns(:pony))
  end
